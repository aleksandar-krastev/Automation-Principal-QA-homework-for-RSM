...
class AmazonUKPageTest {
	...
	public void assertFirstResult() {
		...
		assertAll("Grouped Assertions for the prices of each copy.",
				...
				() -> assertTrue(kindleEditionPricString.matches("^£[1-9]\\d{0,6}\\.\\d{2}$"), "There price "
						+ kindleEditionPricString + " for the Kindle Edition doesn't match the pattern."));
	}
	...
	@Test
	void whenSearchForHarryPotterThenItShowsResultWithAllAvailableCopyOptions() {
